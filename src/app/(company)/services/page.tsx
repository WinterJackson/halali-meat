    ...
    <div className="container mx-auto px-4 py-8 sm:py-12 md:py-16">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
        <div className="relative h-80 md:h-[500px] w-full rounded-lg overflow-hidden shadow-lg">
          <Image src="/images/services-logistics.jpg" alt="Logistics and shipping containers" fill className="object-cover" unoptimized />
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-80 md:h-[500px] w-full rounded-lg overflow-hidden shadow-lg md:order-1">
           <Image src="/images/hero-bg.jpg" alt="A processing facility" fill className="object-cover" unoptimized />
        </div>
      </div>
